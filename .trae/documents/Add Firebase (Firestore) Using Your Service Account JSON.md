...
- SESSION_SECRET=<replace with a real random hex string>
- BREVO_API_KEY=<keep your existing key>
- PORT=5000
...
2) In Firebase Console → Firestore, check the `users` collection for the new document.
